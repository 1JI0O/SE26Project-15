...
def _create_paper_target() -> None:
    op.create_table(
        ...
        sa.Column("paper_document_id", sa.Integer(), sa.ForeignKey("paper_document.id"), nullable=False),
...
def _create_code_target() -> None:
    op.create_table(
        ...
        sa.Column("code_repository_id", sa.Integer(), sa.ForeignKey("code_repository.id"), nullable=False),
